 ...
 * Description: Two-column origin story with image, partner logos, and CTAs.
 *
 * @package Kahel
 * @since   1.0.0
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Origin","patternName":"kahel/origin"},"align":"full","className":"origin section-bordered","style":{"spacing":{"padding":{"top":"100px","bottom":"104px","left":"var:preset|spacing|xl","right":"var:preset|spacing|xl"}}},"layout":{"type":"constrained","contentSize":"1440px"}} -->
<section class="wp-block-group alignfull origin section-bordered" style="padding-top:100px;padding-right:var(--wp--preset--spacing--xl);padding-bottom:104px;padding-left:var(--wp--preset--spacing--xl)"><!-- wp:group {"metadata":{"name":"Origin grid"},"className":"origin-grid","layout":{"type":"default"}} -->
...
<!-- wp:group {"metadata":{"name":"Origin content"},"className":"origin-content","layout":{"type":"default"}} -->
<div class="wp-block-group origin-content"><!-- wp:paragraph {"className":"section-label","fontSize":"small"} -->
<p class="section-label has-small-font-size">Origin</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":2,"className":"section-title"} -->
<h2 class="wp-block-heading section-title">Built by reporters who still believe in the work</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"section-kicker","fontSize":"medium"} -->
...
<!-- wp:html -->
<a href="#" class="text-link">About us <span aria-hidden="true">›</span></a>
<!-- /wp:html --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></section>
