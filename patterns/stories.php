...
<div class="wp-block-query stories-query"><!-- wp:post-template {"layout":{"type":"grid","columnCount":3}} -->
...
<div class="wp-block-group center-action"><!-- wp:buttons {"className":"button-row","layout":{"type":"flex","justifyContent":"center","flexWrap":"wrap"}} -->
